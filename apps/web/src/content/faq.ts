...
export const FAQ: FaqItem[] = [
  // Ерөнхий асуулт
  { id: 'first-consult', category: 'general', question: 'Анхан шатны зөвлөгөө үнэхээр үнэгүй юу?', answer: 'Тийм. 30 минутын анхан шатны уулзалт үнэ төлбөргүй. Энэ уулзалтаар асуудлын мөн чанар, боломжит шийдлийн чиглэлийг тодруулна. Уулзалтын дараа гэрээ байгуулах эсэхийг та шийднэ.' },
  ...
  // Эрүүгийн хэрэг
  { id: 'urgent', category: 'criminal', question: 'Яаралтай тохиолдолд хэрхэн холбогдох вэ?', answer: 'Ажлын цагаар +976 7000-1199, яаралтай үед +976 9911-2233 дугаарт залгана уу. Эрүүгийн хэргийн яаралтай тохиолдолд 24 цагийн дотор хуульч оролцуулна.' },
