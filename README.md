...
│   │       ├── settings/        GET/PUT /settings/bank-account — төлбөр хүлээн авах данс (Setting хүснэгт, ADMIN засна)
...
(Хаан банк · 5023118822 · Тулгуур Хуулийн Фирм ХХН, `apps/api/src/settings/bank-account.ts`) `updatedAt: null`-тэй буцаана.
...
Нийт 393 тест, DB шаардахгүй (Prisma mock). Баг нэмэхээс өмнөх 249 тест хэвээр ногоон.

```bash
pnpm --filter @law-firm/web e2e     # Playwright, web :3001 + api :4000 ажиллаж байх ёстой
```

Playwright (33 тест): нийтийн сайт (2), портал (2), админ (4), баримтын хүсэлт (3), мессеж (3), төлбөр (3), даалгавар (3), мэдэгдэл (2), гүйцэтгэл (3), хонх/Kanban/хавсралт (3), сесс (2), тохиргоо/ноорог нэхэмжлэх (3):
