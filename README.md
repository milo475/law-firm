# Strategy Law Firm — вэб сайт, харилцагчийн портал, админ самбар
...
(Хаан банк · 5023118822 · «Strategy Law Firm» ХХН, `apps/api/src/settings/bank-account.ts`) `updatedAt: null`-тэй буцаана.
...
### Төхөөрөмжийн шалгалт

```bash
pnpm --filter @law-firm/web devices          # бүх хуудас × 9 өргөн
pnpm --filter @law-firm/web devices public   # зөвхөн нэг бүлэг (public | portal | admin)
```

`apps/web/device-audit.mjs` нь production build ажиллаж байхад нийтийн сайт, портал, админы **44
хуудсыг 320–1920px хүртэл 9 өргөнд** ачаалж дараахыг хайна: хуудас хөндлөн гүйлгэх, элемент баруун
ирмэгээс гарах, текст хайрцагтаа таслагдах, утсан дээр хүрэх талбай жижиг байх (товч/талбар 44px,
холбоос 32px). Дэлгэц уншигчийн нуусан текст, `label`-д ороосон талбар, `::after`-аар өргөсгөсөн
хүрэх талбарыг зөв тооцно. Гаралт 0 байх ёстой.
