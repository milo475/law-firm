...
устгахад объект цэвэрлэгдэх. Нийт 382 тест, DB шаардахгүй (Prisma mock). Баг нэмэхээс өмнөх 249 тест хэвээр ногоон.

```bash
pnpm --filter @law-firm/web e2e     # Playwright, web :3001 + api :4000 ажиллаж байх ёстой
```

Playwright (28 тест): нийтийн сайт (2), портал (2), админ (4), баримтын хүсэлт (3), мессеж (3), төлбөр (3), даалгавар (3), мэдэгдэл (2), гүйцэтгэл (3), хонх/Kanban/хавсралт (3):
