...
- **Хонх** (админ header, desktop ба mobile): уншаагүй тооны badge. Тоо 30 секунд тутам болон цонх руу буцаж ороход шинэчлэгдэнэ
...
CANCELLED дууссанд орохгүй, төлөв/ач холбогдлын задаргаа, сүүлийн даалгаврын эрх, timeline бүлэглэл, N+1 байхгүй. Нийт 352 тест, DB шаардахгүй (Prisma mock). Баг нэмэхээс өмнөх 249 тест хэвээр ногоон.

```bash
pnpm --filter @law-firm/web e2e     # Playwright, web :3001 + api :4000 ажиллаж байх ёстой
```

Playwright (25 тест): нийтийн сайт (2), портал (2), админ (4), баримтын хүсэлт (3), мессеж (3), төлбөр (3), даалгавар (3), мэдэгдэл (2), гүйцэтгэл (3):
